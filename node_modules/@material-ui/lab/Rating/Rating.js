...
var Rating = _react.default.forwardRef(function Rating(props, ref) {
  ...
  var _React$useState2 = _react.default.useState(defaultValue),
  ...
  var item = function item(state, labelProps) {
    ...
    var container = _react.default.createElement(IconContainerComponent, {
      value: state.value,
    ...
    return _react.default.createElement(_react.default.Fragment, {
      ...
      htmlFor: id
    }, labelProps), container, _react.default.createElement("span", {
      className: classes.visuallyhidden
    }, getLabelText(state.value))), _react.default.createElement("input", {
      onFocus: handleFocus,
      onBlur: handleBlur,
  ...
  }), !readOnly && !disabled && valueRounded == null && _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("input", {
    value: "",
